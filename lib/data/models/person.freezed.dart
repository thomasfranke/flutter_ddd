...
mixin _$Person {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, age, currencies);

  @override
  String toString() {
    return 'Person(firstName: $firstName, lastName: $lastName, age: $age, currencies: $currencies)';
  }
}
...
abstract mixin class $PersonCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String firstName, String lastName, int age, CurrenciesModel currencies});
}
