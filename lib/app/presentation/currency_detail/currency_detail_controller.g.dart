...
part of 'currency_detail_controller.dart';
...
mixin _$CurrencyController on CurrencyControllerBase, Store {
  late final _$currencyDetailAtom =
      Atom(name: 'CurrencyControllerBase.currencyDetail', context: context);
